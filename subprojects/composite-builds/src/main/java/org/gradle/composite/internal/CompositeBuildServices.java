...
public class CompositeBuildServices extends AbstractPluginServiceRegistry {
    ...
    private static class CompositeBuildTreeScopeServices {
        ...
        public IncludedBuildControllers createIncludedBuildControllers(ExecutorFactory executorFactory, IncludedBuilds includedBuilds, BuildOperationExecutor buildOperationExecutor) {
            return new DefaultIncludedBuildControllers(executorFactory, includedBuilds, buildOperationExecutor);
        }
